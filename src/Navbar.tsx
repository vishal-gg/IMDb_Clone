...
function Navbar() {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className={`flex justify-center items-center bg-[#111111] py-2 text-white font-semibold text-sm max-[990px]:justify-start ${
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 64 32"
          version="1.1"
          className={`cursor-pointer max-[990px]:mx-3 max-[578px]:flex-shrink-0 max-[578px]:${
            toggleVisibility ? "hidden" : undefined
          }`}
          onClick={()=>navigate('/')}
        >
